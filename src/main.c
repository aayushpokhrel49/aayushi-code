...
int main(int argc, char **argv) {
  ...
  SDL_SetAppMetadata("Aayushi Code", LITE_PROJECT_VERSION_STR, "com.aayushi.code");
...
init_lua:
  ...
  const char *init_lite_code = \
    ...
    "  dofile((MACOS_RESOURCES or (prefix and prefix .. '/share/aayushi-code' or exedir .. '/data')) .. '/core/start.lua')\n"
    ...
    "  end\n"
    "  system.show_fatal_error('Aayushi Code internal error',\n"
