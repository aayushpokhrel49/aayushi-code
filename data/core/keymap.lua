...
keymap.add_direct {
  ...
  ["return"] = { "command:submit","context-menu:submit", "autocomplete:complete", "doc:newline", "dialog:select" },
  ["keypad enter"] = { "command:submit", "autocomplete:complete", "doc:newline", "dialog:select" },
