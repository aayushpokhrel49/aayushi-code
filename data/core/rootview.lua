...
function RootView:on_file_dropped(filename, x, y)
  ...
  if info and info.type == "dir" then
    ...
    -- in macOS, when dropping folders into Aayushi Code in the dock,
    -- the OS tries to start an instance of Aayushi Code with each folder as a DND request.
...
function RootView:process_defer_open_docs()
  ...
  for _, drop in ipairs(self.defer_open_docs) do
    -- file dragged into aayushi-code, try to open it
