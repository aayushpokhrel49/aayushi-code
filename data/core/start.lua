-- this file is used by aayushi-code to setup the Lua environment when starting
...
if MACOS_RESOURCES then
  ...
  DATADIR = prefix and (prefix .. PATHSEP .. 'share' .. PATHSEP .. 'aayushi-code') or (EXEDIR .. PATHSEP .. 'data')
end
