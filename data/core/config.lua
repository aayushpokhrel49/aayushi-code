...
---
---When set to true, Aayushi Code draws its own window decorations,
...
---Maximum number of clicks recognized by Aayushi Code.
---
---Defaults to 3.
---@type number
config.max_clicks = 3
...
---
---This fork (mod-version 4) enables this so that the LSP server plugins
---from the lite-xl ecosystem (which are still mod-version 3) can be loaded.
---Defaults to false.
---@type boolean
