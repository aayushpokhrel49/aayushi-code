...
---# Swift - sourcekit-lsp
--- __Status__: Works
--- __Site__: https://github.com/swiftlang/sourcekit-lsp
--- __Installation__: Comes bundled with Xcode on macOS, or via the Swift toolchain
lspconfig.sourcekit_lsp = add_lsp {
  name = "sourcekit-lsp",
  language = "swift",
  file_patterns = { "%.swift$" },
...
---# Vue.js - Volar
--- __Status__: Works
--- __Site__: https://github.com/vuejs/language-tools
--- __Installation__: `npm install -g @vue/language-server` (requires `typescript`,
---                   the language server binary is `vue-language-server`)
lspconfig.volar = add_lsp {
  name = "volar",
  language = "vue",
  file_patterns = { "%.vue$" },
  command = {
