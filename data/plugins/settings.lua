...
function Settings:setup_about()
  ---@type widget.label
  local title = Label(self.about, "Aayushi Code")
  title.font = "big_font"
  ---@type widget.label
  ...
  function self.about:update_positions()
    ...
    for _, b in ipairs(row) do
      row_width = row_width + b:get_width()
    end
    row_width = row_width + (gap * (#row - 1))
    local bx = center - row_width / 2
    for _, b in ipairs(row) do
